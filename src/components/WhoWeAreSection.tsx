      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-corporate-dark to-bv-darker p-8 rounded-2xl shadow-elegant">
              <h3 className="text-xl font-semibold text-bv-cyan mb-4">BV INNOVATION</h3>
